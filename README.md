# Setup-ExternalDisk-Linux

Setup

First, plug in your disk to your Linux machine. Find out which disk it is. In my case, it’s sda. <br>
...
Now I can close the encrypted disk to reopen it below with the normal workflow:<br>
sudo cryptsetup luksClose backup-disk

Usage

First unlock the disk:<br>
sudo cryptsetup luksOpen /dev/sda1 backup-disk

Mount the disk and navigate to it:<br>
